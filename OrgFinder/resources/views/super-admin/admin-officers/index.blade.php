                ...
                <tr>
                    ...
                    <td style="text-align:center;">
                        <div style="display:flex;gap:6px;justify-content:center;align-items:center;">
                            @if($officer['status'] === 'active')
                                <button class="icon-btn" title="Block" onclick="confirmBlock({{ $officer['id'] }}, '{{ addslashes($officer['first_name'] . ' ' . $officer['last_name']) }}')">
                            ...
                            @endif
                            <button class="icon-btn" title="Delete" onclick="confirmDelete({{ $officer['id'] }}, '{{ addslashes($officer['first_name'] . ' ' . $officer['last_name']) }}')">
