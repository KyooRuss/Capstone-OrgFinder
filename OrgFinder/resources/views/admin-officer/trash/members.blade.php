...
@section('title', 'Trash - Members')
@section('page-title', 'Archived Members')
@section('page-subtitle', 'View and restore removed members')

@section('content')
<div class="card">
    <div class="toolbar">
        <div class="toolbar-left">Total Archived Members: {{ $members->count() }}</div>
        <form method="GET" style="display:contents;">
            ...
            <div class="filter-wrap">
                <button type="button" class="filter-btn" onclick="toggleFilter('trashMemberFilterDrop')">
                ...
                <div class="filter-drop" id="trashMemberFilterDrop">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="text-align:center;white-space:nowrap;display:flex;gap:6px;justify-content:center;">
                        <button class="btn btn-success btn-sm" onclick="restoreUser({{ $member->id }})">Restore</button>
                        <button class="btn btn-danger btn-sm" onclick="confirmDelete({{ $member->id }})">Delete</button>
                    </td>
                </tr>
                @empty
                <tr>
                    <td colspan="6" style="text-align:center;color:#94a3b8;padding:40px;border-radius:10px;">No archived members.</td>
                </tr>
                @endforelse
            </tbody>
        </table>
